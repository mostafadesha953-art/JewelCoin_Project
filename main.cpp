...
public:
    ...
    // ãÑÍáÉ ÅØáÇŞ Ãæá ÚãáÉ JewelCoin (Genesis Mining)
    void mineFirstBlock() {
        Block genesis;
        genesis.index = 0;
        ...
        while (true) {
            ...
            if (genesis.hash.substr(0, 4) == "0000") {
                ...
                std::cout << "?? ÇáãßÇİÃÉ ÇáÃæáì ÇáãÖÇİÉ ááãÍİÙÉ: 50 JWL" << std::endl;
...
int main() {
    Blockchain jwl; // ÓíŞæã ÊáŞÇÆíÇğ ÈÊÚÏíä Ãæá ßÊáÉ ÚäÏ ÇáÈÏÁ
    crow::SimpleApp app;
